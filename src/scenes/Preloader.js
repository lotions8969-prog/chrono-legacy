...
export class Preloader extends Phaser.Scene {
    ...
    buildPlayerSprite() {
        ...
        const frame = (fi, boot14, boot15, overrides = {}) => {
    ...
    buildNPCSprite() {
        ...
        const npcA = (fi, legOff) => paint(fi * FW, [
        ...
        const npcB = (fi, legOff) => paint(fi * FW, [
    ...
    buildEnemySprite() {
        ...
        const slime = (fi, bounce) => {
            ...
            // Left eye
            ctx.fillStyle = pal['k'];
            ctx.fillRect(ox + 3, ey, 2, 2);
            ctx.fillStyle = pal['w'];
            ctx.fillRect(ox + 3, ey, 1, 1);
            // Right eye
            ctx.fillStyle = pal['k'];
            ctx.fillRect(ox + 9, ey, 2, 2);
            ctx.fillStyle = pal['w'];
            ctx.fillRect(ox + 9, ey, 1, 1);
            // mouth (happy arc)
            ctx.fillStyle = pal['k'];
